    ...
    fun createShuffledActionDrawPile(seed: Long? = null): ActionDrawPile {
        ...
        val actionCards = List(ACTION_CARD_COUNT) { index ->
            ...
            when {
                ...
                index < DEFENSE_CARD_COUNT + PLAYER_SWAP_CARD_COUNT -> SkyjoCard.ActionCard.PlayerSwapCard(id)
                index < DEFENSE_CARD_COUNT + PLAYER_SWAP_CARD_COUNT + DOUBLE_TURN_CARD_COUNT -> SkyjoCard.ActionCard.DoubleTurn(id)
